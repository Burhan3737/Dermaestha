...
import { lockSchema, cancelSchema } from '#shared/schemas/appointment/appointment.js';

describe('booking schemas', () => {
  it('lockSchema accepts a self booking', () => {
    const r = lockSchema.safeParse({
      doctorId: 'd1',
      slotStart: '2026-06-15T13:00:00.000Z',
      forSelf: true,
    });
    expect(r.success).toBe(true);
  });
  it('lockSchema requires subject fields when forSelf is false', () => {
    const bad = lockSchema.safeParse({
      doctorId: 'd1',
      slotStart: '2026-06-15T13:00:00.000Z',
      forSelf: false,
    });
