...
- **Still open (broader, NOT done):** ~6 other stale pointers to deprecated docs outside the prisma scope — `CONFIG.md`/`INTEGRATIONS.md`/`API.md` refs in docs 05 (×4) and 14 (×2); plus provenance-borderline mirror/pairs-with refs in 15/06. Presented for a go/no-go.
