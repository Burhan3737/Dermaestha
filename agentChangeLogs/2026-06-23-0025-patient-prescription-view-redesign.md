...
- **Doctor (D-05) — keep `MedicineSearch` as-is:** the e2e (`j3`) drives it via `getByLabel('Add medicine')` + `getByRole('option')`; left untouched and wrapped the new layout around it.
