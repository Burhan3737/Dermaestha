...
**Status:** In Progress (Tasks 7–8 complete; Task 9 complete)
...
- Tasks 10–13 remaining: client scaffold + ported tokens; Docker; admin bootstrap; README/runbook.
