...
| **M4 — Launch-ready**          | End of week 8 | In progress | ~60%                  | Slice G built F10–F14 backends + A-01..A-05 views + DA5 reset; Slice H · S1 wired the PayFast Pakistan adapter; remaining: landing page, legal content, email template copy, the Daily.co network adapter, full E2E QA                       |
